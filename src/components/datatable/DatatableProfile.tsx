...
import styles from "./styles/datatable-profile.module.css";
...
interface DatatableProfileProps<TData> {
...
// @ts-ignore
const DatatableProfile: React.FC<DatatableProfileProps<TData>> = ({
  data,
  columns,
  showPagination,
  showFooter,
